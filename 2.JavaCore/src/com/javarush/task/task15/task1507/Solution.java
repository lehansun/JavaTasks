...
public class Solution {
    ...
    public static void printMatrix(int m, int n, int l, String c) {
        System.out.println("One more step");
    }


    public static void printMatrix(int m, int n, String c, int l) {
        System.out.println("One more step");
    }
    public static void printMatrix(int m, String c, int n, int l) {
        System.out.println("One more step");
    }
}
