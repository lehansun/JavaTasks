...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (name == 0) {
                    int date = compareDate(stock1, stock2);
                    if (date == 0) {
    ...
    private static int compareProfit(Stock stock1, Stock stock2) {
        int profit1 = getProfitPercentage(stock1);
        int profit2 = getProfitPercentage(stock2);
        return profit2 - profit1;
    }

    private static int getProfitPercentage(Stock stock) {
        double res;
    ...
    private static int compareDate(Solution.Stock stock1, Solution.Stock stock2) {
